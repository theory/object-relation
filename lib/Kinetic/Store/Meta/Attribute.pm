package Kinetic::Store::Meta::Attribute;
...
Kinetic::Store::Meta::Attribute - Kinetic object attribute introspection

=head1 Synopsis

  # Assuming MyThingy was generated by Kinetic::Store::Meta.
...
Kinetic::Store::Meta::Attribute in addition to those defined by
...
sub new {
    ...
    $self->{widget_meta} ||= Kinetic::Store::Meta::Widget->new( type => 'text' );
...
returns a Kinetic::Store::Meta::Class::Schema object representing that class. This is
...
method will return the Kinetic::Store::Meta::Class object describing that class. This
attribute is implicitly set by Kinetic::Store::Meta for classes that either extend
another class or reference other classes via the "type_of" relationship. In
those cases, Kinetic::Store::Meta will create extra attributes to delegate to the
...
If C<delegates_to()> returns a Kinetic::Store::Meta::Class object representing the
class of object to which the attribute delegates, C<acts_as()> returns the
Kinetic::Store::Meta::Attribute object to which this attribute corresponds. That is,
...
sub build {
    ...
    my $type = Kinetic::Store::Meta::Type->new($self->type);
    ...
    # Can these maybe be creaed by Kinetic::Store::Meta::Type?
...
When creating a new C<Kinetic::Store::Meta::Attribute> object, some attributes of the
...
sub _prepare_kinetic {
    ...
    # Kinetic::Store::Meta class. Use Class::Meta->for_key to avoid
    # Kinetic::Store::Meta->for_key's exception.
    ...
    Kinetic::Store::Meta->for_key($arg_for{type})->_add_container($class_key);
