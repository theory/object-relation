package Kinetic::Store::Meta::Attribute::Schema;
...
use Kinetic::Store::Meta::Attribute ':with_dbstore_api';
use base 'Kinetic::Store::Meta::Attribute';

=head1 Name

Kinetic::Store::Meta::Attribute::Schema - Kinetic database store builder

=head1 Synopsis

  # Assuming MyThingy was generated by Kinetic::Store::Meta and that we're building
  # a data store schema.
...
of L<Kinetic::Store::Meta::Attribute|Kinetic::Store::Meta::Attribute>. This is so that extra
...
attribute. Pass in a Kinetic::Store::Meta::Class object to use its key for the class
