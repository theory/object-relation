...
L<Kinetic::Store::Handle|Kinetic::Store::Handle> recognizes. In the future, if someone wishes
...
L<Kinetic::Store::Exception::Fatal::Search|Kinetic::Store::Exception::Fatal::Search>
...
L<Kinetic::Store::Handle|Kinetic::Store::Handle>. These subroutines return self-lexing
