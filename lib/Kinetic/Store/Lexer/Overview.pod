...
Then it examines more of the seach request. If what follows is a string, it
...
For this example, the code lexter the following stack:
...
The C<COMPARE> and C<VALUE> tokens are then pushed onto the stack, yeilding:
