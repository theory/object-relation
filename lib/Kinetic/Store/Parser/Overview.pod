...
L<Kinetic::Store|Kinetic::Store> subclasses can use to initiate searches
against a datastore.
...
L<Kinetic::DataType::DateTime::Incomplete|Kinetic::DataType::DateTime::Incomplete> string and, if
...
L<Kinetic::Store|Kinetic::Store> object that was passed in to validate that
