...
Kinetic::Store::Handle::DB::Overview - Developer's overview of Kinetic::Store::Handle::DB
...
DBMS. DBMS specific behavior is implemented via the C<Kinetic::Store::Handle::DB::Pg>
and C<Kinetic::Store::Handle::DBI::SQLite> classes.

This discussion will be a high-level overview of how the C<Kinetic::Store::Handle::DB>
class operates.
...
create or modify the appropriate records. Thus, C<Kinetic::Store::Handle::DB> merely
...
This method returns a L<Kinetic::Store::Iterator|Kinetic::Store::Iterator>
object containing all objects that match the query parameters. See
L<Kinetic::Store::Handle|Kinetic::Store::Handle> for detailed information about query
parameters.
...
cleverly named C<&_set_search_data>. This method uses the C<Kinetic::Store::Meta>
...
must be defined in C<Kinetic::Store::Handle::DB> or a subclass. It works like this:
...
method usually returns a L<Kinetic::Store::Iterator|Kinetic::Store::Iterator>
