...
Object::Relation::Store::DB::Overview - Developer's overview of Object::Relation::Store::DB
...
DBMS. DBMS specific behavior is implemented via the C<Object::Relation::Store::DB::Pg>
and C<Object::Relation::Store::DBI::SQLite> classes.

This discussion will be a high-level overview of how the C<Object::Relation::Store::DB>
class operates.
...
create or modify the appropriate records. Thus, C<Object::Relation::Store::DB> merely
...
L<Object::Relation::Store|Object::Relation::Store> for detailed information about query
parameters.
...
must be defined in C<Object::Relation::Store::DB> or a subclass. It works like this:
