...
L<Kinetic::Store::DataType::State|Kinetic::Store::DataType::State> for details on the
...
generated by L<Kinetic::Store::Meta::AccessorBuilder|Kinetic::Store::Meta::AccessorBuilder>.
